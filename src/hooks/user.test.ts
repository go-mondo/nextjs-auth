...
const originalPublicSessionRoute = process.env.NEXT_PUBLIC_SESSION_ROUTE;

describe('fetchUserProfile', () => {
  beforeEach(() => {
    delete process.env.NEXT_PUBLIC_SESSION_ROUTE;
...
function restorePublicSessionRoute() {
  ...
  process.env.NEXT_PUBLIC_SESSION_ROUTE = originalPublicSessionRoute;
}
